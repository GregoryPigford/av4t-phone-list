...
function hashPin(pin) { return crypto.createHash('sha256').update(pin + 'av4t2025salt').digest('hex'); }
  ...
  await resend.emails.send({
    ...
    html: `<div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:2rem">
      ...
      <div style="background:#fef9c3;border:1px solid #fde68a;border-radius:8px;padding:.9rem;margin-bottom:1rem">
        <p style="color:#92400e;font-size:.83rem;line-height:1.65;margin:0">⚠️ Please update this to something private at <a href="${SITE}" style="color:#c96a20">av4t.com</a> → Me → Update My Info.</p>
      </div>
